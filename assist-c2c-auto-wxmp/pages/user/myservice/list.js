...
Page({
  ...
  loadDataList: function(){
    ...
    utils.request(
      app.globalData.apiBaseUrl+'/service/my/list',
      req
    ).then(res=>{
  ...
  toCampList: function(e){
    let bid = e.currentTarget.dataset.sid
    console.log('跳转到抢单列表页',bid)
    wx.navigateTo({
      url: '/pages/user/myservice/service-camp?sid='+bid,
    })
  },
})